...
Write-Host "- If Squarespace shows a Verify your email address banner for church@fillmorechristian.org, complete that verification before requesting the transfer code."
Write-Host ""

Write-Host "Next Cloudflare Registrar step"
Write-Host "1. In Squarespace Domains for $Domain, complete the Verify your email address banner first if it is visible."
Write-Host "2. Click Request transfer code if the latest code is not already available."
Write-Host "3. Check church@fillmorechristian.org for the Squarespace transfer authorization code."
Write-Host "4. Open Cloudflare Dashboard > Domains > Transfers."
Write-Host "5. Confirm $Domain is selected and shows Ready for transfer."
Write-Host "6. Enter the Squarespace transfer authorization code in Step 2."
Write-Host "7. Continue to payment and start the transfer in Cloudflare."
Write-Host ""
...
Write-Host "3. After Cloudflare shows the transfer complete, run: npm run verify:registrar-ownership"
Write-Host "4. Revoke temporary Cloudflare API tokens after the transfer is underway and the receipt stays green."
