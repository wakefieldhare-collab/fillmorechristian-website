...
"@
    ...
    if ($durationLabel) {
        $episodeMetaParts += "<span class=""sermon-duration"">Duration $(HtmlEncode $durationLabel)</span>"
    }
  ...
  <nav class="navbar">
    <div class="container">
      <a href="../../index.html" class="nav-brand">
        <img src="../../images/fcc-logo-mark.png" alt="" class="nav-brand-logo" aria-hidden="true">
...
$episodeNavMarkup
  ...
  <script src="../../js/main.js?v=20260602-03"></script>
</body>
</html>
"@
